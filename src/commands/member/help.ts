...
export const command: Command = {
    ...
    async execute(interaction) {
        ...
        // @ts-ignore
        const { commands } = interaction.client.commandHandler as { commands: Collection<string, Command> };
        ...
        commands.forEach(c => {
            ...
            if (category) {
                ...
                categories.set(c.category as string, new Collection().set(c.data.name, c) as Collection<string, Command>);
            }
        });
